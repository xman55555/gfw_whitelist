var wall_proxy = "SOCKS5 127.0.0.1:1080;SOCKS5 127.0.0.1:10808;SOCKS5 127.0.0.1:9758";
...
function isInDomainsLocalhost( host) {
    var intIpLocal = convertAddress(strIp);
    if(host=="10.252.184.97"){
        return true;
    }
    return false;
}
...
function FindProxyForURL(url, host) {
	url=""+url;
	host=""+host;
	if(isInDomainsLocalhost(host)===true){
	    debugger;
	    return wall_proxy;
    }
